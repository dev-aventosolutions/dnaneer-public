...
<head>
    ...
    <title>Institutional POA Agreement</title>
</head>
...
<body style="
    ...
    <section>
      ...
      ">
            ...
            <div>
                <h2>رقم الاتفاقية: {{$data['serial_number']}}</h2>
            </div>
        </div>
    ...
    <section>
      ...
      ">
        ...
        "> :أطراف الاتفاقية </h2>
          ...
          font-weight: 500;
        ">
        ثانياً: {{$data['company_name']}} سجل تجاري رقم {{$data['cr_number']}} وتـاريخ {{$data['cr_issuing_date']}} وعنوانها الرئيسي:      {{$data['address']}} ويُشار إليه في هذه الاتفاقية بأسم "الطرف الثاني" أو "المستثمر" أو "المستخدم"  ويُشار إلى الطرف الأول والطرف الثاني مجتمعين فيما بعد بـــــــ(الطرفان/الطرفين).
...
عند توقيع هذه الاتفاقية فأن الطرف الثاني وافق على ان للوكيل أو للشركة دمج مبلغ الاستثمار مع أي من الأصول والأموال الأخرى التي يتسلَّمها الوكيل من المستثمرين، وذلــِــك في فترات زمنية مُحددة. 
        ...
        "> :المادة السادسة: مدة الاستثمار </h2>
          ...
          "> تسري هذه الاتفاقية من تاريخ توقيعها، وتنتهي بصورةٍ تلقائية في حال ألغى "الطرف الثاني" أو "المستثمر" حسابه على منصة الشركة الإلكتروني، أو إذا قامت الشركة باستحداث تعديلات على شروط وأحكام هذه الاتفاقية. </li>
            ...
            padding-top: 20px;
            ">
          مدة كل فرصة استثمارية تختلف من فرصة الى أخرى يتم تحديدها في منصة المستثمرين ويمكن للمستثمر الاطلاع على مدة كل فرصة قبل الدخول في الاستثمار عبر المنصة. 
                </li>
                <li style="
            font-size: 1.25em !important;
            font-weight: 500;
...
<ol style="font-weight: bold; direction: rtl">
    ...
    <section>
        ...
        <div style="text-align: right">
            <h2 style="font-weight: 500; font-size: 1.46em; font-weight: 500 !important"> 
            :حررت هذه الاتفاقية من نسخ الكترونية</h2>
            <h2 style="font-weight: 500; font-size: 1.46em; font-weight: 500 !important">
        ...
        <div style="display: flex; justify-content: space-around; flex-wrap: wrap">
            ...
            font-size: 1.46em;
            font-weight: 500 !important;
            ">الموكل/المستثمر: {{$data['company_name']}} </h2>
            <h2 style="
            width: 50%;
            text-align: center;
            font-weight: 500;
            ...
            font-weight: 500 !important;
            ">
            يمثلها الأستاذ / {{$data['contact_person_name']}}
        </h2>
        ...
        <div style="display: flex; justify-content: space-between; flex-wrap: wrap">
            ...
            font-weight: 500 !important;
            ">
            التوقيع: {{$data['contact_person_name']}}
        </h2>
            <h2 style="
            width: 50%;
            text-align: right;
