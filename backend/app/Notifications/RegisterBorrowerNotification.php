...
class RegisterBorrowerNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->recipientType === 'admin') {
            ...
            Notifications::create([
                ...
                'text' => 'A new borrower ('.$this->data->email.') is registered on the dnaneer.',
                'url' => null,
                'seen' => 0,
                'is_admin' => 1
            ]);
    ...
    protected function adminContent()
    {
        return (new MailMessage)
            ...
            ->line('A new borrower ('.$this->data->email.') is registered on the dnaneer.')
            ->line('Thank you');
    }
