...
class InstitutionalKYCNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->recipientType === 'admin') {
            ...
            Notifications::create([
                ...
                'title' => 'Institutional KYC Form',
                'text' => 'A institutional user ('.$this->data->email.') submitted their kyc fo rm.',
                'url' => null,
                'seen' => 0,
                'is_admin' =>1
            ]);
    ...
    protected function adminContent()
    {
        return (new MailMessage)
            ->line('KYC Form:')
            ->line('A Institutional user ('.$this->data->email.') submitted his KYC form.')
            ->line('Thank you');
    }
