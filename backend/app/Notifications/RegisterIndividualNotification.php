...
class RegisterIndividualNotification extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        if ($this->recipientType === 'admin') {
            ...
            Notifications::create([
                ...
                'text' => 'A individual user ('.$this->data->email.') is registered on the dnaneer.',
                'url' => null,
                'seen' => 0,
                'is_admin' => 1
            ]);
    ...
    protected function adminContent()
    {
        return (new MailMessage)
            ...
            ->line('A individual user ('.$this->data->email.') is registered on the dnaneer.')
            ->line('Thank you');
    }
