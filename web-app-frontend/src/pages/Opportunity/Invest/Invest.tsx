...
const Invest = ({ detailOpportunity }) => {
  ...
  const [investInpuVal, setInvestInput] = useState("0");
  const [showInvestment, setShowInvestment] = useState(false);

  let Percent = (detailOpportunity?.net_roi / 100).toFixed(2);
  let PercentAnnual = (detailOpportunity?.annual_roi / 100).toFixed(2);
  let durationInyears = (detailOpportunity?.duration / 12).toFixed(2);

  const investmentCaluculate = (value) =>
    setInvestment(
      commaSeparator(
        (
          +value.replaceAll(",", "") *
  ...
  const confirmTransfer = async () => {
        ...
        if (data) {
          ...
          try {
            ...
            const { data } = await investOpportunity({
              ...
              opportunity_id: detailOpportunity.id,
    ...
    //   parseFloat(investInpuVal.replace(/,/g, ""))
    // );
  };
  const handlePercentage = () => {
    const fundAmount = parseInt(detailOpportunity?.fund_needed);
              ...
              {showConfirm ? (
                <>
                  ...
                  {/* <p style={{ marginTop: "15px" }}>
                    our team will send you a confirmation message{" "}
                  </p> */}
                  <AppButton
                    block
          ...
          <div className="invest box-shadow">
            {showInvestment ? (
              <>
                ...
                <p className="net-roi">{`The annual ROI ${detailOpportunity?.annual_roi}% * duration ${detailOpportunity?.duration} months`}</p>
                <Button
                  style={{
                    marginTop: "37px",
                    width: "100%",
              ...
              <div
                className={
                  detailOpportunity?.opportunity_status === "comingsoon" ||
          ...
          <Card className="details-card">
            ...
            <Row>
              <Col lg={12}>
                ...
                <h2>#{maskCRNumber(detailOpportunity.cr_number)}</h2>
              </Col>
              <Col lg={12}>
                <p>Annual Revenue</p>
                <h2>{detailOpportunity.annual_revenue}</h2>
              </Col>
            </Row>
            <Row>
              <Col lg={12}>
                <p>Establishment Date</p>
                <h2>{detailOpportunity.establishment_date}</h2>
              </Col>
              <Col lg={12}>
                <p>Location</p>
                <h2>{detailOpportunity.company_location}</h2>
              </Col>
            </Row>
          </Card>
        </Col>
