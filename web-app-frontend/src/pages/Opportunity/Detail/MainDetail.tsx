...
const MainDetail = ({ detailOpportunity }) => {
  const content = (
    <>
    ...
    <Row justify="center">
        ...
        <div className="main-detail-col1">
          ...
          <div className="opportunity-code-container">
            <h3 style={{ fontWeight: "bold" }}>
              #{detailOpportunity.opportunity_number}
            </h3>
            <h5 className="secondary-text">
              {detailOpportunity.industry_name}
            </h5>
          </div>
        </div>
      </Col>
      ...
      <Col md={6}>
        <div className="flex-column-start">
          <div style={{ display: "flex", alignItems: "center" }}>
            <Rating />
            <h2 className="medium-heading ">
              Risk Score: {detailOpportunity.risk_score}
            </h2>
            <Popover
              content={content}
              placement="top"
            ...
            >
              <div style={{ marginLeft: ".5rem", marginTop: "1px" }}>
                <Info />
              </div>
            </Popover>
          </div>
      ...
      <Col md={6}>
        <div className="flex-column-start ">
          <Time />
          <h2 className="medium-heading ">
            {detailOpportunity.duration} Months
          </h2>
        </div>
      </Col>
    </Row>
