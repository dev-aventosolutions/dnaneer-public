...
const FinancingDetail = ({ detailInvestment }) => {
  const content = (
    <>
      ...
      <Row gutter={[24, 24]}>
        <Col md={6}>
          <FinancingElements
            ...
            value={detailInvestment.financing_structure}
          />
        </Col>
        <Col md={6}>
          <FinancingElements
            heading="Financing type"
            value={detailInvestment.financing_type}
          />
        </Col>
        <Col md={6}>
          <FinancingElements
            heading="Net ROI"
            value={detailInvestment.net_roi + " %"}
          />
        </Col>
        <Col md={6}>
          <FinancingElements
            heading="Due Date"
            value={detailInvestment.due_date}
          />
        </Col>
      </Row>
      <Row style={{ marginTop: "26px" }} gutter={[24, 24]}>
        <Col md={6}>
          ...
          >
            <FinancingElements
              heading="Risk Score"
              value={detailInvestment.risk_score}
            />
            <Popover
              content={content}
              placement="top"
        ...
        <Col md={6}>
          <FinancingElements
            ...
            value={
              commaSeparator(detailInvestment.distributed_returns) + " SAR"
            }
          />
        </Col>
        <Col md={6}>
          <FinancingElements
            ...
            value={commaSeparator(detailInvestment.fund_needed) + " SAR"}
          />
        </Col>
        <Col md={6}>
          <FinancingElements
            ...
            value={
              detailInvestment?.repayment_period
                ? detailInvestment?.repayment_period == "1"
                  ? "Monthly"
                  : detailInvestment?.repayment_period + " Months"
                : "-"
            }
          />
        </Col>
